  ...
  <div class="home-energy">
    ...
    <div class="cover flex flex-col items-center">
      <div class="flex justify-between" style="padding: 0.5rem 0;width: 90%;">
        <div class="cover-item item-back flex flex-col justify-center" v-for="item in overviewListI18n" :key="item.subNum">
      ...
      <div class="middle-title flex items-center px-4" style="width: 90%;">
        <div class="middle-text flex items-center">
          <div>{{ $t(`system.dailyEnergyGeneration`)}}</div>
...
const overviewListI18n = computed(() => [
    { title: i18n.t('system.countries'), num: '30+', unit: isZh.value ? '个' : '' },
    { title: i18n.t('system.users'), num: '3000+', unit: isZh.value ? '个': '' },
    { title: i18n.t('system.pVCapacity'), num: '180+', unit: 'MWh' },
    { title: i18n.t('system.bATCapacity'), num: '30', unit: 'MWh' },
])
